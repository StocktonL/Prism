  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
      ...
      <div className="relative w-full max-w-md rounded-3xl bg-white border border-slate-200 p-8 shadow-2xl">
        <button onClick={onClose} className="absolute top-5 right-5 text-slate-500 hover:text-slate-900 transition-colors">
          <X className="h-5 w-5" />
        </button>
        ...
        <div className="mb-6">
          <div className="flex items-center gap-2 mb-4">
            ...
            <span className="rounded-full bg-amber-50 border border-amber-200 px-3 py-1 text-xs font-bold text-amber-600">
              {TOTAL_SPOTS - SPOTS_TAKEN} of {TOTAL_SPOTS} spots remaining
            </span>
          </div>
          <h2 className="text-xl font-black text-slate-900">Apply for Founding Access</h2>
        ...
        <form onSubmit={handleSubmit} className="space-y-3">
          ...
          <div className="grid grid-cols-2 gap-3">
            <div>
              ...
              <input
                ...
                className="w-full rounded-xl border border-slate-300 bg-white px-4 py-3 text-sm text-slate-900 placeholder-slate-400 focus:border-teal-600 focus:outline-none focus:ring-1 focus:ring-teal-600"
              />
          ...
          <div className="grid grid-cols-2 gap-3">
            <div>
              ...
              <select
                name="patientCount"
                className="w-full rounded-xl border border-slate-300 bg-white px-4 py-3 text-sm text-slate-900 focus:border-teal-600 focus:outline-none focus:ring-1 focus:ring-teal-600"
              >
          ...
          <div>
            ...
            <textarea
              ...
              className="w-full rounded-xl border border-slate-300 bg-white px-4 py-3 text-sm text-slate-900 placeholder-slate-400 focus:border-teal-600 focus:outline-none focus:ring-1 focus:ring-teal-600 resize-none"
            />
          </div>
          ...
          <button
            ...
            className="flex w-full items-center justify-center gap-2 rounded-xl bg-amber-500 py-3.5 text-sm font-bold text-white hover:bg-amber-600 transition-colors disabled:opacity-60 disabled:cursor-not-allowed"
          >
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
      ...
      <div className="relative w-full max-w-md rounded-3xl bg-white border border-slate-200 p-8 shadow-2xl text-center">
        ...
        <button onClick={onDismiss} className="w-full rounded-xl bg-teal-600 py-3 text-sm font-bold text-white hover:bg-teal-700 transition-colors">
          Got it
        </button>
      </div>
    </div>
    ...
    <div className="min-h-screen bg-[#FAFBFF] text-slate-900">
      ...
      <nav className="flex items-center justify-between px-6 py-5 max-w-5xl mx-auto">
        <button onClick={() => navigate('/')} className="flex items-center gap-2">
          ...
          <span className="text-base font-black tracking-tight text-slate-900">Prizm</span>
        </button>
        <button
          onClick={() => navigate('/')}
      ...
      <div className="max-w-4xl mx-auto px-6 pb-24">
        ...
        {/* Hero */}
        <div className="pt-12 pb-16 text-center -mx-6 px-6 rounded-b-3xl bg-gradient-to-b from-amber-50 via-white to-[#FAFBFF]">
          ...
          <p className="text-sm text-teal-600 font-medium mt-2">Only 10 founding spots available</p>
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
            <button
              ...
              className="flex items-center gap-2 rounded-2xl bg-amber-500 px-8 py-4 text-base font-bold text-white hover:bg-amber-600 transition-colors shadow-lg shadow-amber-500/20"
            >
        ...
        <div className="grid grid-cols-2 sm:grid-cols-4 gap-4 mb-16">
          {stats.map((s) => (
            <div key={s.value} className="rounded-2xl border border-slate-200 bg-white shadow-sm p-4 text-center">
        ...
        <div className="rounded-3xl border border-teal-100 bg-teal-50 p-8 mb-16">
          <p className="text-xs font-bold uppercase tracking-widest text-teal-600 mb-4">Example: 1,800-patient VSP practice</p>
          <div className="grid sm:grid-cols-3 gap-6 mb-6">
            <div className="text-center">
              <p className="text-4xl font-black text-slate-900">{roiExample.withBenefits.toLocaleString()}</p>
              <p className="text-sm text-slate-600 mt-1">patients with unused benefits</p>
            </div>
            <div className="text-center">
              <p className="text-4xl font-black text-teal-600">${recoverable.toLocaleString()}</p>
              <p className="text-sm text-slate-600 mt-1">in allowances sitting unclaimed</p>
            </div>
            <div className="text-center">
              <p className="text-4xl font-black text-emerald-600">${estimatedRevenue.toLocaleString()}</p>
        ...
        {/* What you get */}
        <div className="mb-16">
          <h2 className="text-2xl font-black text-center mb-2 text-slate-900">What founding customers get</h2>
          ...
          <div className="grid sm:grid-cols-2 gap-4">
            {foundingPerks.map((perk) => (
              <div key={perk.title} className="flex gap-4 rounded-2xl border border-slate-200 bg-white shadow-sm p-5">
        ...
        <div className="rounded-3xl border border-slate-200 bg-slate-50 p-8 mb-16">
          <h2 className="text-xl font-black mb-2 text-slate-900">What we're asking in return</h2>
        ...
        <div className="rounded-3xl border border-slate-200 bg-white shadow-sm p-8 mb-16">
          <h2 className="text-xl font-black mb-4 text-slate-900">Who's building this</h2>
        ...
        {/* FAQ */}
        <div className="mb-16">
          <h2 className="text-2xl font-black text-center mb-10 text-slate-900">Common questions</h2>
          <div className="space-y-4">
            {[
              ...
              <div key={q} className="rounded-2xl border border-slate-200 bg-white shadow-sm p-5">
        ...
        {/* Final CTA */}
        <div className="rounded-3xl bg-gradient-to-br from-amber-500 to-amber-600 p-10 text-center text-white">
          ...
          <button
            onClick={() => setShowForm(true)}
            className="inline-flex items-center gap-2 rounded-2xl bg-white px-10 py-4 text-base font-bold text-amber-700 hover:bg-amber-50 transition-colors shadow-lg shadow-amber-900/20"
          >
            Claim my founding spot <ArrowRight className="h-4 w-4" />
          </button>
